        ...
        <form name="frm"  method="post">
            ...
            <table  width="1000" border="2" align="center">
                ...
                <tr>
                    ...
                    String dt= request.getParameter("duedt");
                     String rt= request.getParameter("rdt");
                      String am1= request.getParameter("amount");
                    int a1=Integer.parseInt("am1");
                     String m= request.getParameter("mode");
                        String cn= request.getParameter("chno");
                        String bk= request.getParameter("bank");
                        String ct= request.getParameter("cdt");
